...
// Modified to not deploy Native Covnerters, and instead fetch them from input.json.
contract RedeployLayerY is Script {
    ...
    function deployLayerY() public {
        ...
        for (uint256 i = 0; i < vbTokens.length; i++) {
            ...
            address nativeConverter = input.readAddress(string.concat(vbSlug, ".nativeConverter"));
            ...
            IERC1967Proxy customTokenProxy;
