...
function _.assetsBeforeTransferFee(uint256) external => DISPATCHER(true);
...
// function _.__VaultBackedTokenInit_init(address,string,string,address,uint256,address,address,address,(uint32,address)[],uint256,address) external => DISPATCHER(true);
}
