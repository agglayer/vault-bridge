...
contract GenericVaultBridgeTokenTest is Test {
    ...
    function test_initialize_twice() public {
        ...
        vbToken.initialize(initDataStruct, initializer);
    }
    ...
    function test_initialize() public virtual {
        ...
        initDataStruct.owner = address(0);
