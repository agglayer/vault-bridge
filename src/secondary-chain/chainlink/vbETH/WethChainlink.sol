...
// Vault Bridge (last updated v1.2.0) (secondary-chain/chainlink/vbETH/WethChainlink.sol)
...
/// @title WETH (Chainlink)
/// @author See https://github.com/agglayer/vault-bridge
contract WethChainlink is CustomTokenChainlink, CustomTokenWethExtension {
    constructor() {
    ...
    function reinitialize1(
        ...
        __CustomToken_init1(owner_, name_, symbol_, originalUnderlyingTokenDecimals_, tokenPool_, address(0));
    ...
    */
    ...
    function setNativeConverter(address)
        external
        view
        override(CustomToken, CustomTokenChainlink)
