...
<<<<<<< HEAD:src/VaultBridgeTokenInitializer.sol
=======
// Vault Bridge (last updated v1.0.0) (primary-chain/VaultBridgeTokenInitializer.sol)

>>>>>>> origin/git/feat/v1.0.0:src/primary-chain/VaultBridgeTokenInitializer.sol
...
contract VaultBridgeTokenInitializer is IVaultBridgeTokenInitializer, VaultBridgeToken {
    ...
    function init1(VaultBridgeToken.InitializationParameters calldata initParams) external override onlyInitializing {
        ...
        require(
            keccak256(bytes(VaultBridgeToken(initParams.vaultBridgeTokenPart2).VAULT_BRIDGE_PROTOCOL()))
